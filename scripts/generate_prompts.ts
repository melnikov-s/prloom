...
const designer = readFileSync(join(promptsDir, "designer.md"), "utf-8");
const worker = readFileSync(join(promptsDir, "worker.md"), "utf-8");
const reviewTriage = readFileSync(join(promptsDir, "review_triage.md"), "utf-8");

const out = `// This file is generated by scripts/generate_prompts.ts
// Do not edit directly.

export type PromptName = "designer" | "worker" | "review_triage";

export const BUILTIN_PROMPTS: Record<PromptName, string> = {
  designer: ${jsStringLiteral(designer)},
