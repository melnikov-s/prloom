...
export function renderWorkerPrompt(
  ...
  let prompt = compiled({
    ...
    plan_architecture_notes: plan.architectureNotes,
    plan_decision_log: plan.decisionLog,
    plan_implementation_notes: plan.implementationNotes,
    plan_specific_checks: plan.planSpecificChecks,
    plan_review_focus: plan.reviewFocus,
    plan_open_questions: plan.openQuestions,
